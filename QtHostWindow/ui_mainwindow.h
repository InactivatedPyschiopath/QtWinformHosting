...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(815, 410);
        actionNew_File = new QAction(MainWindow);
        actionNew_File->setObjectName(QString::fromUtf8("actionNew_File"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/resources/File.ico"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionNew_File->setShortcut(QCoreApplication::translate("MainWindow", "Ctrl+F", nullptr));
